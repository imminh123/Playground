import type { Asset, ExperienceInventory, Skill, Companion } from '../types';
...
export const mockSkills: Skill[] = [
  {
    ...
    description: 'Search and retrieve information from linked documents using RAG',
    type: 'knowledge-retrieval',
    enabled: true,
    config: {
      assetIds: ['doc-7', 'doc-1', 'folder-1'],
    },
  },
  {
    id: 'skill-2',
